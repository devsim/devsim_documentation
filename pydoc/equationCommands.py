  ...
  "commands" : (
      {
          ...
          "parameters" : (
              ...
              ("volume_model", "Name of the element model being integrated over the volume of each edge on the contact", optional, string, None, None),
...
''',
          "parameters" : (
              ...
              ("volume_model", "Name of the element model being integrated over the volume of each edge in the device volume", optional, string, None, None),
